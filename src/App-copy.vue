    ...
    <div class="fixed z-30 w-full" :class="[{ 'bg-scrolled': isScrolled }]">
      <nav class="container h-30 flex items-center justify-between px-5 py-3 relative text-white">
        <a href="./" class="w-1/3 max-w-[60px]">
          <img src="@/assets/img/logo-tolko.svg" alt="Logo Tolko Group" class="w-full" width="60" height="60" fetchpriority="high" loading="lazy" />
        </a>
        <div class="flex items-center justify-end gap-2">
          ...
          <div class="fixed inset-0 bg-gradient-to-b from-white/20 to-tolko-red/70 translate-x-full peer-checked:translate-x-0 transition-transform md:static md:translate-x-0 md:bg-none">
            <ul
              ...
              <li>
                <a href="#about" @click="scrollToSection(1); cerrarMenu();">
                  {{ $t('menu.about_us') }}
                </a>
              </li>
              <li>
                <a href="#services" @click="scrollToSection(2); cerrarMenu();">
                  {{ $t('menu.our_services') }}
                </a>
              </li>
              <li>
                <a href="#" @click="scrollToSection(3); cerrarMenu();">
                  {{ $t('menu.join_our_team') }}
                </a>
              </li>
              <li>
                <a
                  href="#contact" :class="['py-2.5 px-2.5 rounded-[15px] hover:opacity-80 ', activeSection === 'section6' ? 'bg-tolko-red text-white' : 'bg-tolko-red text-white']" @click="scrollToSection(4); cerrarMenu();">

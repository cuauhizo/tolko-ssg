export const messages = {
  en: {
    ...
    careers: {
      ...
      learn_doing: 'Learn by doing and creating<br>for real brands',
      we_look_for: 'We look for:',
      req_1: 'Students from <strong class="font-bold">5th to 7th semester</strong> in Communication, Marketing, or Advertising',
      req_2: 'Unlimited curiosity, <strong>turbo creativity, and a proactive attitude</strong>',
      req_3: '<strong>Advanced English is a plus</strong> so you can participate in global projects',
      scheme_title: 'Schedule:',
      scheme_desc: '20 hours per week, on-site in Polanco',
      you_gain_title: 'What you gain:',
      you_gain_desc: 'Mentorship, real experience, growth, and a financial stipend',
      form: {
        placeholderName: 'Full Name',
        requiredName: 'Name is required.',
        placeholderTelephone: 'Phone Number',
        requiredTelephone: 'Phone number is required.',
        placeholderEmail: 'Email Address',
        requiredEmail: 'Email is required.',
        formatEmail: 'Enter a valid email.',
        labelCV: 'Attach your CV (PDF or Word)',
        requiredCV: 'Attaching your resume is required.',
        send: 'Submit CV',
        loading: 'Loading form...',
        sending: 'Sending...',
        success: 'Your information was sent successfully!',
        errorGeneral: 'There was an error sending your application. Please try again.',
        errorSize: 'The file exceeds the 2MB limit.',
      },
    },
    footer: {
      list1: {
  ...
  es: {
    ...
    careers: {
      ...
      learn_doing: 'Aprende haciendo y creando<br>para marcas reales',
      we_look_for: 'Buscamos:',
      req_1: 'Estudiantes de <strong class="font-bold">5<sup>o</sup> a 7<sup>o</sup> semestre</strong> de Comunicación, Marketing o Publicidad',
      req_2: 'Curiosidad ilimitada, <strong>creatividad turbo y actitud de proponer</strong>',
      req_3: '<strong>Inglés avanzado es un plus</strong> para que puedas estar en proyectos globales',
      scheme_title: 'Esquema:',
      scheme_desc: '20 horas a la semana, presenciales en Polanco',
      you_gain_title: 'Tú ganas:',
      you_gain_desc: 'Mentoría, experiencia real, crecimiento y un apoyo económico',
      form: {
        placeholderName: 'Nombre completo',
        requiredName: 'El nombre es obligatorio.',
        placeholderTelephone: 'Teléfono',
        requiredTelephone: 'El teléfono es obligatorio.',
        placeholderEmail: 'Correo electrónico',
        requiredEmail: 'El correo es obligatorio.',
        formatEmail: 'Ingresa un correo válido.',
        labelCV: 'Adjunta tu CV (PDF o Word)',
        requiredCV: 'Es necesario adjuntar tu currículum.',
        send: 'Enviar CV',
        loading: 'Cargando formulario...',
        sending: 'Enviando...',
        success: '¡Tu información se envió con éxito!',
        errorGeneral: 'Hubo un error al enviar tu solicitud. Intenta nuevamente.',
        errorSize: 'El archivo supera los 2MB permitidos.',
      },
    },
    footer: {
      list1: {
